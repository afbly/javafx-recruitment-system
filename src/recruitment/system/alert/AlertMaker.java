package recruitment.system.alert;
...
public class AlertMaker {
    ...
    public static void successMessage(StackPane container, String header, String body) {
        JFXButton button = new JFXButton("Okay");
        JFXDialogLayout dialogLayout = new JFXDialogLayout();
        JFXDialog dialog = new JFXDialog(container, dialogLayout, JFXDialog.DialogTransition.TOP);
    ...
    public static void showTrayMessage(String title, String message) {
        try {
            ...
            BufferedImage image = ImageIO.read(AlertMaker.class.getResource(RecruitmentSystemUtil.ICON_IMAGE_LOC));
    ...
    private static void styleAlert(Alert alert) {
        ...
        dialogPane.getStylesheets().add(AlertMaker.class.getResource("/resources/stylesheet.css").toExternalForm());
